...
{
    /// <summary>
    /// Provides logic to indicate whether given measurement satisfies the optimal application plan.
    /// </summary>
    [ForPlan(ApplicationPlan.Optimal)]
    internal sealed class OptimalPlanSuitabilityFilter : ApplicationPlanSuitabilityFilter
    {
        /// <summary>
        /// Indicates whether the given <seealso cref="IMeasurement" /> is suitable for the optimal application plan.
        /// </summary>
        ...
        internal override bool IsSuitable(IMeasurement measurement, bool _) =>
            new BodyMassIndex(measurement).IsNormalWeight();
    }
}